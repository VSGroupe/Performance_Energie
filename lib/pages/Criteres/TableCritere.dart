...
import 'package:perf_energie/pages/Criteres/TabAffichageCritere.dart';
...
class TabCritere extends StatefulWidget {
    
  const TabCritere({super.key});

  @override
  State<TabCritere> createState() => _TabCritereState();
}

class _TabCritereState extends State<TabCritere> {
                  ...
                  children: [
                    ...
                    CardMoule(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              const Text("TABLEAU DE BORD PAR CRITERES",
                                  style: TextStyle(
                                    fontSize: 20,
