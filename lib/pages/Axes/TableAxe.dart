...
import 'package:perf_energie/pages/Axes/TabAffichageAxe.dart';
...
class TabAxes extends StatefulWidget {
    
  const TabAxes({super.key});

  @override
  State<TabAxes> createState() => _TabAxesState();
}

class _TabAxesState extends State<TabAxes> {
                  ...
                  children: [
                    ...
                    CardMoule(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              const Text("TABLEAU DE BORD PAR AXES",
                                  style: TextStyle(
                                    fontSize: 20,
