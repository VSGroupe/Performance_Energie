...
import 'package:perf_energie/pages/Processus/TabAffichageProcessus.dart';
...
class TabProcessus extends StatefulWidget {
    
  const TabProcessus({super.key});

  @override
  State<TabProcessus> createState() => _TabProcessusState();
}

class _TabProcessusState extends State<TabProcessus> {
                  ...
                  children: [
                    ...
                    CardMoule(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              const Text("TABLEAU DE BORD INDICATEURS PAR PROCESSUS",
                                  style: TextStyle(
                                    fontSize: 20,
